...
@section('title', __('general.create_category'))
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('backend.categories.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-primary w-md me-3">{{ __('general.create_category') }}</button>
